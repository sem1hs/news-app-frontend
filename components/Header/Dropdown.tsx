...
const Dropdown = ({ dropdownItems }: Props) => {
  return (
    <div className="absolute top-full left-1/2 -translate-x-1/2 pt-0.5 pointer-events-none">
      <div className="w-48 rounded-xl bg-[#111517] shadow-lg border border-zinc-800 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition delay-100 pointer-events-auto">
